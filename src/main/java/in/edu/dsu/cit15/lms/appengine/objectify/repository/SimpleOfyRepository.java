 ...
 *
 * @param <T>  The type of the com.abhishekmunie.epls.data.entity to handle
 * @param <ID> The type of the com.abhishekmunie.epls.data.entity's identifier
...
public class SimpleOfyRepository<T, ID extends Serializable> implements OfyRepository<T, ID> {
  ...
  @Autowired
  @Qualifier("objectifyFactory")
  protected OfyService ofyService;

  protected Class<T> type;

  public SimpleOfyRepository() {
  ...
  public void delete(T entity) {
    Assert.notNull(entity, "The com.abhishekmunie.epls.data.entity must not be null");
  ...
  /**
   * Start a delete command chain for the given com.abhishekmunie.epls.data.entity type.
   *
  ...
  /**
   * Start a load command chain for the given com.abhishekmunie.epls.data.entity type.
   *
   * @see Deleter#type(Class)
   */
