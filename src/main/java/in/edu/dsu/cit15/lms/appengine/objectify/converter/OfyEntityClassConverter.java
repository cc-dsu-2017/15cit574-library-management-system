 ...
 */
package in.edu.dsu.cit15.lms.appengine.objectify.converter;
...
public class OfyEntityClassConverter<T extends ConversionService & ConverterRegistry> implements ConditionalGenericConverter, ApplicationContextAware {
  ...
  public boolean matches(TypeDescriptor sourceType, TypeDescriptor targetType) {
    try {
      ...
      // IllegalArgumentException will be thrown if target type is not registered as com.abhishekmunie.epls.data.entity class
