...
public class UniqueValidator implements ConstraintValidator<Unique, Object> {
  ...
  public boolean isValid(Object value, ConstraintValidatorContext context) {
    // get meta data of the com.abhishekmunie.epls.data.entity class to validate, and return exception if not found
    ...
    // get value of com.abhishekmunie.epls.data.entity id
    ...
    for (Object obj : list) {
      // if id of stored com.abhishekmunie.epls.data.entity does not equal id of com.abhishekmunie.epls.data.entity being validated, then add constraint violation
      // if id of stored com.abhishekmunie.epls.data.entity does equal id of com.abhishekmunie.epls.data.entity being validated, this means com.abhishekmunie.epls.data.entity is being updated and unique constraint is not violated
